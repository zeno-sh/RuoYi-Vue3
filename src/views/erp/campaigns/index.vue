  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="点击数" prop="clicks">
        <el-input v-model="queryParams.clicks" placeholder="请输入点击数" clearable @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="广告花费" prop="moneySpent">
        <el-input v-model="queryParams.moneySpent" placeholder="请输入广告花费" clearable @keyup.enter="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="订单数量" prop="orders">
        <el-input v-model="queryParams.orders" placeholder="请输入订单数量" clearable @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="campaignsList" @selection-change="handleSelectionChange">
